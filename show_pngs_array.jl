...
w = Window(Dict("width" => 2500,"height" => 2200))

# o = Interact.radiobuttons( OrderedDict( "PNG"=>string("/Figure_per/"), "GIF"=>string("GIF") ), value=string("/Figure_per/"))
